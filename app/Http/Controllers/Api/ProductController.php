...
class ProductController extends Controller
{
    ...
    public function index(request $request)
    {
        ...
        // $product = Product::with('user')->whereHas('user', function ($query) use ($request) {
        //     $query->where('roles', 'restaurant');
        // })->get();

        return response()->json([
            'status' => 'success',
            'message' => 'Product data laoded successfully',
            'data' => $products
        ]);
    }
    ...
    {
        $product = Product::with('user')->where('user_id', $request->user_id)->get();
